...
public class CameraManager : MonoBehaviour
{
    ...
    public List<CameraPositions> seaLevelCameraPos = new List<CameraPositions>();
    ...
    private void Awake()
    {
        ...
        allCameraPos = new List<List<CameraPositions>>() { bottomCameraPos, middleCameraPos, topCameraPos, seaLevelCameraPos };
    }
